...
class View
{
     ...
     * @return mixed
     */
    public static function fetch(string $file, ReplacementData $data){
        return (new self($file))->fetch_data($data);
    }
    ...
    {
        $this->file = full_path('resources/views/' . $file);
    }
